...
costume5 = Costume.new(name: 'Doctor Costume', size: "M", condition: "new", price: 4, owner: user1, age: "Children", gender: "Unisex", description: "Classic doctor ensemble: white coat, stethoscope, scrubs. Perfect for parties, events, and roleplay.")
